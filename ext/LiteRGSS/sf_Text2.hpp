...
/// \ingroup graphics
///
/// sf::Text2 is a drawable class that allows to easily display
...
///
/// sf::Text2 works in combination with the sf::Font class, which
/// loads and provides the glyphs (visual characters) of a given font.
///
/// The separation of sf::Font and sf::Text2 allows more flexibility
...
/// used by a sf::Text2 (i.e. never write a function that
